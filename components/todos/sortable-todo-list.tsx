...
export default function SortableTodoList({
    ...
    return (
        <div className="flex flex-col gap-4">
            {/* Part 1: Header Section with Summary */}
            ...
            {/* Part 2: Add Todo Section */}
            <div>
                <AddTodoModal />
            </div>

            {/* Part 3: Active Todos Section */}
            ...
            {/* Part 4: Completed Todos Section */}
            <div className="flex flex-col">
                <div className="flex items-center justify-between mb-2">
            ...
            <div className="mt-2 p-4 border border-red-200 dark:border-red-800/50 rounded-lg bg-red-50/50 dark:bg-red-900/10">
                <div className="flex items-center justify-between">
                    <div>
